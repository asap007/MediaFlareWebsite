...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex flex-col items-center justify-center bg-black px-4 py-8 sm:px-6 lg:px-8">
        ...
        >
          <div className="absolute w-full h-full">
            {[0, 1, 2].map((_, index) => (
              <div
                key={index}
                className="absolute w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 bg-orange-600 rounded-full shadow-lg"
                style={{
                  top: '50%',
                  left: '50%',
              ...
              >
                <div className="w-full h-full rounded-full flex items-center justify-center">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 bg-black rounded-full flex items-center justify-center shadow-inner">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-white rounded-full" />
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="absolute w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-orange-600 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-xl">
            <div className="w-full h-full rounded-full flex items-center justify-center">
              <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-18 lg:h-18 bg-black rounded-full flex items-center justify-center shadow-inner">
      ...
      <div className="relative z-10 text-center">
        <motion.div
          className="text-orange-600 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold glitch"
